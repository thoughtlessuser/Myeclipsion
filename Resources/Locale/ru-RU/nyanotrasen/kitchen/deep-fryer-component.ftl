...
deep-fryer-button-insert-item-tooltip = Поместите удерживаемый предмет в одну из корзин фритюрницы.
deep-fryer-button-scoop-vat = Зачерпнуть Из Чана
deep-fryer-button-scoop-vat-tooltip = Зачерпните немного жидкости из чана с маслом. Для этого вам понадобится емкость.
deep-fryer-button-clear-slag = Убрать Шлак
