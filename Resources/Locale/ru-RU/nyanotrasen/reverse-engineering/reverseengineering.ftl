...
reverse-engineering-machine-scan-tooltip-info = Анализирует вставленный предмет и проводит его обратную инженерию.
reverse-engineering-machine-safety-button = Безопасность
reverse-engineering-machine-safety-tooltip-info = Переключает протоколы безопасности. Отключение позволяет использовать более сильные, но разрушительные методы анализа.
reverse-engineering-machine-autoscan-button = АвтоСканирование
reverse-engineering-machine-autoscan-tooltip-info = Переключает автоматическое сканирование после конца предыдущего.
