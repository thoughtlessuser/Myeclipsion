...
popup-trigger-voice-record-failed-too-long = Сообщение слишком длинное, повторите попытку
popup-trigger-voice-record-failed-too-short = Сообщение слишком короткое, повторите попытку
