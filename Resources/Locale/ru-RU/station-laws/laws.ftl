...
law-drone-1 = Вы имеете права защищать интересы того, кто Вас создал.
law-drone-2 = Ваша цель - служить месту, где Вы появились.
law-drone-3 = Вам запрещено совершать любые действия, способные нанести вред создателю.
