...
ent-ClothingHeadHatFezMantis = mantis' fez
...
ent-ClothingHeadHatBeretCap = берет блюстителя
    .desc = Синий берет с эмблемой блюстителя ополчения. Стильный, и показывает, кто тут на опыте.
