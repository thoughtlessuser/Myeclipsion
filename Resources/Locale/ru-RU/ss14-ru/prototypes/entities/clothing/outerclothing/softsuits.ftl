...
ent-ClothingOuterSuitEmergency = emergency vacsuit
    .desc = An emergency vacsuit with a built-in helmet. It's horribly slow and lacking in temperature protection, but enough to buy you time from the harsh vacuum of space.
...
ent-ClothingOuterHardsuitAncientEVA = NTSRA vacsuit
    .desc = An ancient vacsuit, designed by the NTSRA branch of CentComm. It is very finely crafted, allowing for greater mobility than most modern vacsuits.
