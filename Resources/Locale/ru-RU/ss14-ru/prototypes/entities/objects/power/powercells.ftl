...
ent-PowerCellMicrortg = микро радиоизотопный термоэлектрический генератор
    .desc = Прототип перезаряжаемого микро-ртг элемента. Обладает меньшей емкостью, но медленно перезаряжается сам по себе. Не обладает достаточной защитой от радиации.
    .suffix = Полный
