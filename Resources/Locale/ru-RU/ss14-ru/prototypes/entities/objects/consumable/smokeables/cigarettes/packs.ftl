...
ent-CigPackMixedMedical = Пропитанные сигареты Дэна
    .desc = Дэн работал с компанией NT-химия над утилизацией излишков химикатов, НАСЛАЖДАЙТЕСЬ.
    .suffix = Медицинские
ent-CigPackMixed = { ent-CigPackMixedMedical }
    .desc = { ent-CigPackMixedMedical.desc }
    .suffix = Смешанные
ent-CigPackMixedNasty = { ent-CigPackMixedMedical }
    .desc = { ent-CigPackMixedMedical.desc }
    .suffix = Противные
