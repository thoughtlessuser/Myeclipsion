...
ent-ShuttleGunPirateCannon = pirate ship cannon
    .desc = Kaboom!
ent-ShuttleGunKinetic = PTK-800 "Материализатор"
    .desc = Стационарная шахтёрская турель. Постепенно накапливает заряды, эффективна для добычи астероидов.
ent-ShuttleGunGrapple = Абордажная пушка
    .desc = Стреляет цепью, не давая шаттлу уйти.
